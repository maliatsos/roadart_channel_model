function [phi_aods, phi_aoas, distances] = signage_scatterer_angles(index, linkParams, layoutParams)
...
tmp = sum(linkParams.actives_signs);
...
for kk = 1 : layoutParams.num_signs
    if linkParams.actives_signs(kk,time)
        y1 = coordinates_tx(2);
        x1 = coordinates_tx(1);
